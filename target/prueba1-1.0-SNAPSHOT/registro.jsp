            ...
            <form action="Controlador?accion=Registrar" method="POST">
                <div class="bg-white p-5 rounded-5 text-secondary" style="width: 25rem">
                    ...
                    <div class="input-group mt-4">
                        ...
                        <input class="form-control bg-light" type="text" name="txt_nombre" placeholder="User"/>
                    </div>
                    <div class="input-group mt-2">
                        ...
                        <input class="form-control mt-2 bg-light" type="text" name="txt_correo" placeholder="Correo"/>
                    </div>
                    ...
                    <div class="input-group mt-2">
                        ...
                        <input class="form-control mt-2 bg-light" type="text" name="txt_telefono" placeholder="Telefono"/>
                    </div>
                    ...
                    <div class="input-group mt-2">
                        ...
                        <input class="form-control mt-2 bg-light" type="password" name="txt_clave" placeholder="Contraseña"/>
                    </div>
                    
            </form>
            
            <div>
                <input class="btn btn-info text-white w-100 mt-3 fw-semibold shadow-sm" type="submit" name="accion" value="Registrar">
            </div>
